...
The loyalty principle the mindset rests on lives in the reference. See [references/loyalty.md](references/loyalty.md).
...
The full question bank lives in the reference. See [references/questions.md](references/questions.md).

## Common Mistakes

The catalogue of architectural mistakes lives in the reference. See [references/common-mistakes.md](references/common-mistakes.md).
...
How loyalty applies to AI operation lives in the reference. See [references/ai-operational-loyalty.md](references/ai-operational-loyalty.md).
...
The spec-driven workflow extension lives in the reference. See [references/spec-driven-development.md](references/spec-driven-development.md).
