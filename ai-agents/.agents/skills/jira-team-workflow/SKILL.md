...
description: >-
  ...
  для этого есть отдельный skill jira-issue-author. Этот skill про движение и инспекцию существующих задач.
---
...
Создание и декомпозиция задач (PRD, RFC, ADR, Epic в тикеты, единый формат) живут в skill `jira-issue-author` и его reference `jira_issue_authoring.md`. Правила оформления здесь не дублируются.
