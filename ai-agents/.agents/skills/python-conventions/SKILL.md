...
description: User-level conventions for Python code - Google-style docstrings with Russian content and strict pytest test-writing rules (structure, docstrings, assertions, fixtures, test doubles, async, parameterization, typing, observability). Use whenever writing, editing, or reviewing Python code, adding or improving docstrings, or writing, modifying, or reviewing Python tests, even if the user does not mention conventions explicitly.
---

# Python Conventions

These rules apply to Python code in any repository unless the project styleguide explicitly overrides them.
