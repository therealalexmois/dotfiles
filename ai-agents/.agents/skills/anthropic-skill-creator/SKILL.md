...
2. **Aggregate into benchmark** — run the aggregation script from the anthropic-skill-creator directory:
   ```bash
...
4. **Launch the viewer** with both qualitative outputs and quantitative data:
   ```bash
   nohup python <anthropic-skill-creator-path>/eval-viewer/generate_review.py \
