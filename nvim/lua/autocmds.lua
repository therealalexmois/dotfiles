...
cmd(
  "AstroChangelog",
  function() require("utils.updater").changelog() end,
...
cmd("AstroRollback", function() require("utils.updater").rollback() end, { desc = "Rollback AstroNvim" })
cmd("AstroUpdate", function() require("utils.updater").update() end, { desc = "Update AstroNvim" })
cmd("AstroVersion", function() require("utils.updater").version() end, { desc = "Check AstroNvim Version" })
cmd("AstroReload", function() require("utils").reload() end, { desc = "Reload AstroNvim (Experimental)" })
