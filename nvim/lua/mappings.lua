...
maps.n["<leader>bse"] =
{ function() require("utils.buffer").sort "extension" end, desc = "Sort by extension (buffers)" }
maps.n["<leader>bsr"] =
{ function() require("utils.buffer").sort "unique_path" end, desc = "Sort by relative path (buffers)" }
maps.n["<leader>bsp"] =
{ function() require("utils.buffer").sort "full_path" end, desc = "Sort by full path (buffers)" }
maps.n["<leader>bsi"] =
{ function() require("utils.buffer").sort "bufnr" end, desc = "Sort by buffer number (buffers)" }
maps.n["<leader>bsm"] =
{ function() require("utils.buffer").sort "modified" end, desc = "Sort by modification (buffers)" }
maps.n["<leader>b\\"] = {
  function()
