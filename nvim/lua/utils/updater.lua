...
--
-- This module can also loaded with `local updater = require("utils.updater")`
--
...
function M.update(opts)
  ...
  opts = require("utils").extend_tbl({ remote = "origin", show_changelog = true, auto_quit = false }, opts)
