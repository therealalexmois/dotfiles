--- ### Git LUA API
--
-- This module can be loaded with `local git = require "utils.git"`
--
-- @module utils.git
-- @copyright 2022
...
function git.cmd(args, ...)
  return require("utils").cmd("git -C " .. astronvim.install.home .. " " .. args, ...)
end
...
---@param commits string[] an array like table of commit messages
---@return string[][] # An array like table of echo messages to provide to nvim_echo or .echo
