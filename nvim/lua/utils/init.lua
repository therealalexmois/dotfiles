...
function M.reload(quiet)
  local core_modules = { "bootstrap", "options", "mappings" }
...
function M.get_icon(kind)
  ...
  if not M[icon_pack] then
    M.icons = astronvim.user_opts("icons", require "icons.nerd_font")
    M.text_icons = astronvim.user_opts("text_icons", require "icons.text")
  end
